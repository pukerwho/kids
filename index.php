	...
	<div class="welcome mb-8">
		<div class="w-full md:w-2/3 flex items-center flex-col mx-auto">
			...
			<div class="welcome_content kids-animate text-xl text-center">
				Ми любимо та зберігаємо сімейні традиції, саме тому кожне наше свято
унікальне, яскраве та щире. Найцінніша нагорода для нас – блиск дитячих
очей, адже діти не вміють приховувати емоції. Дитячі свята запам’ятовуються
на все життя, і ми знаємо, як зробити ці спогади найтеплішими.
			</div>	
		</div>
	</div>
